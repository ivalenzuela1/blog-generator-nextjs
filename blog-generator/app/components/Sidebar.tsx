...
export default function Sidebar() {
  ...
  return (
    <>
      {user ? (
        <div className="bg-white border border-gray-100 py-2 flex flex-shrink-0 flex-row justify-around md:justify-start md:flex-col md:h-full md:w-32 z-10 sticky top-0">
          {menu.map((item, index) => (
            <div key={index}>
              <Link
                href={item.route}
